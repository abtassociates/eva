      ...
      tabItem(
        ...
        fluidRow(
          tabBox(
            ...
            tabPanel("Top 10 Organizations", uiOutput("sysDQHighPriorityByOrg_ui")),
            tabPanel("Issues", uiOutput("sysDQHighPriorityByIssue_ui")),
            width = 12
          )
        ),
        fluidRow(
          tabBox(
            ...
            tabPanel("Top 10 Organizations", uiOutput("sysDQErrorByOrg_ui")),
            tabPanel("Top 10 Issues", uiOutput("sysDQErrorByIssue_ui")),
            width =12
          )
        ),
        fluidRow(
          tabBox(
            ...
            selected = "Top 10 Issues",
            title = "Warnings",
            tabPanel("Top 10 Organizations", uiOutput("sysDQWarningByOrg_ui")),
            tabPanel("Top 10 Issues", uiOutput("sysDQWarningByIssue_ui")),
            width = 12
          )
        )
      ),
      tabItem(
        ...
        fluidRow(
          tabBox(
            ...
            selected = "Issues",
            title = "High Priority Errors",
            tabPanel("Top 10 Projects", uiOutput("orgDQHighPriorityByProject_ui")  %>% withSpinner()),
            tabPanel("Issues", uiOutput("orgDQHighPriorityByIssue_ui") %>% withSpinner()),
            width = 12
          )
        ),
        fluidRow(
          tabBox(
            ...
            selected = "Top 10 Issues",
            title = "General Errors",
            tabPanel("Top 10 Projects", uiOutput("orgDQErrorByProject_ui") %>% withSpinner()),
        ...
        fluidRow(
          tabBox(
            ...
            selected = "Top 10 Issues",
            title = "Warnings",
            tabPanel("Top 10 Projects", uiOutput("orgDQWarningByProject_ui") %>% withSpinner()),
            tabPanel("Top 10 Issues", uiOutput("orgDQWarningByIssue_ui") %>% withSpinner()),
            width = 12
          )
        ),
