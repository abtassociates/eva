...
#### Need to drop certain rows from staging - Prior to <PUSH DATE>, reduce syso tabular downloads by # of ppt downloads for each type of download

matching_columns <- c("SessionID", "DateTimeMinute", "EventCategory" ) # Columns to check for matching values

# Identify rows to drop
to_drop <- c()
#if Date < [PUSH DATE] ######## NEED TO FINALIZE BEFORE PUSH
