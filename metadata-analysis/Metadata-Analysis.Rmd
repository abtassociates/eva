...
visits <-
  ...
  #read_lines(here("~/sdrive_ce/eva_dz/metadata-analysis/metadata/site_visits.txt"))
uploads <-
  read_lines(here("metadata-analysis/metadata/upload_metadata.txt"))
  #read_lines(here("~/sdrive_ce/eva_dz/metadata-analysis/metadata/upload_metadata.txt"))

session_data <- read_csv(here("metadata-analysis/metadata/sessiondata.csv")) %>%
#session_data <- read_csv(here("~/sdrive_ce/eva_dz/metadata-analysis/metadata/sessiondata.csv")) %>%
...
new_way <-
  ...
  #read_csv(here("~/sdrive_ce/eva_dz/metadata-analysis/metadata/metadata.csv")) %>%
  group_by(SessionToken) %>%
...
start_date_last6months <- end_date_last6months - months(5) + 1
...
#  ggplot(aes(x = MonthEnding, y = n, group = Event, fill = Event)) +
#  geom_bar(stat = "identity") +
#  scale_fill_manual(values = 
#                      c("Successful upload" = "#208b3a",
#                      "Unsuccessful upload - incomplete dataset" = "#ff0606",
#                      "Unsuccessful upload - not an HMIS CSV Export" = "#ff4b00",
#                      "Unsuccessful upload - not hashed" = "#ff6f00",
#                      "Unsuccessful upload - not structurally valid" = "#ff8f00",
#                      "Unsuccessful upload - out of date HMIS CSV Export" = "#ffac00",
#                      "Unsuccessful upload - wrong/incomplete dataset" = "#ffc700",
#                      "Unsuccessful upload - zip file not.zip" = "#ffe200",
#                      "Unsuccessful upload - zip file was misstructured" = "#fffc00")) +
#   geom_text(
#    aes(label = ifelse(Event == "Successful upload", n, "")), vjust = -0.5, size = 3) +
