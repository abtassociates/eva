...
counts_category <- count(all_month, MonthEnding, EventCategory) %>%
  arrange(MonthEnding, desc(n))
...
# Bar chart
#tab_percentage_january_to_may %>%
#mutate(Page = factor(Page, levels = c("Local Settings", "Client Counts", "PDDE DQ", "System DQ", "Organization DQ", "Changelog"))) %>% 
#ggplot(aes(x = Page, y = Percentage, fill = Page)) +
#  geom_bar(stat = "identity") +
...
# Bar chart
#tab_percentage_june_to_november %>%
#mutate(Page = factor(Page, levels = c("Local Settings", "Client Counts", "PDDE DQ", "System DQ", "Organization DQ", "Changelog"))) %>% 
#ggplot(aes(x = Page, y = Percentage, fill = Page)) +
#  geom_bar(stat = "identity") +
#  scale_y_continuous(limits = c(0,35)) +
