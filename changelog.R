output$changelog <- renderDT({
  tribble(
    ...
    "<b>Bug Fixes</b> <br>
      ...
      - Fix SSVF HP Screening DQ check (Issue <a href='https://github.com/abtassociates/eva/issues/782' target='_blank'>#677</a> and <a href='https://github.com/abtassociates/eva/issues/713' target='_blank'>#782</a>).<br>
     <b>Miscellaneous</b> <br>
      - Update Long Stayers check for ES NbN projects to use Bed Nights, rather than CLS records.<br>
      - Update System Overview instruction text
