...
# whenever DDS sends the metadata zip file, copy it to anywhere in the ACE environment that you can find it again, navigate to the sandbox directory in your Eva RStudio project, click Upload, then find the zip file you copied in. Click OK or whatever, then the files will be pasted into a folder under sandbox/. 
...
counts %>%
  ...
  ggplot(aes(x = WeekStarting, y = n, group = Event, color = Event, label = n)) +
  geom_line() +
  geom_point() +
...
Below are the counts by Week. Week Starting counts Monday to Sunday.
