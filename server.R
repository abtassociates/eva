...
function(input, output, session) {
  ...
  source(here("rcode", "server_07.1.1_syso_status.R"), local = TRUE)
  source(here("rcode", "server_07.1.2_syso_inflow_outflow.R"), local = TRUE)
  source(here("rcode", "server_07.1.3_syso_composition.R"), local = TRUE)
