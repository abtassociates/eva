...
output$client_level_download_btn <- downloadHandler(
  ...
  content = function(file) {
    detail_client_fields <- c(
      ...
      "MidEastNorAfAloneMethod1Detailed" = "MENAAloneMethod1Detailed",
      "MidEastNorAfLatineMethod1Detailed" = "MENALatineMethod1Detailed",
      ...
      "MidEastNorAfMethod2Detailed" = "MENAMethod2Detailed",
