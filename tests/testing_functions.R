...
main_test_script <- function(test_script_name = "main-valid", test_dataset = "tests/temp/FY26-test-main-valid.zip",
  ...
  test_that(paste0("{shinytest2} recording: ",test_script_name), {
    ...
    if(run_system_exits){
      ...
      customDownload(app, "syse__download_btn", "System-Exit-Comparison-Download.xlsx")
...
review_helper <- function(datasetname, test_script_name = "main-valid", comparison_type = 1) {
...
records_in_one_or_another <- function(old, new, datasetname) {
