...
# whenever DDS uploads the metadata zip file to ACE (S:\Projects\CE_Data_Toolkit\Eva metadata), navigate to the metadata directory in your Eva RStudio project, click Upload, then Choose File (not Browse), then upload that zip file. Click OK or whatever and the metadata.csv file should be uploaded to the directroy. Run this.
