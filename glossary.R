gloss <- tribble(
  ...
  "All Panels",
  "Demographic Filters",
  "Filters that affect all system performance charts except demographics crosstab charts.
  ...
  "A single-select universal filter that allows users to filter system performance 
    ...
    at subcategories of household types for Youth and Young Adults. Households may be 
    counted in more than one household type. For example, a 16-year-old parent with a
    1-year-old child would fall into the Child Only and Youth and Young Adult household 
    types. Eva system performance metrics and statuses reported by household type are 
    calculated based on project enrollments associated with the respective household type.",
  
  "Filters",
  "Household Type",
  "All Household Types",
  "Households of all household types as well as households that are not categorized 
    due to missing data.",
  ...
  "Households in which all members are under 25 years old. This category includes 
    Child Only (CO) households, Adult Only (AO) 18-24 households, and Adult Child (AC) 
    Parenting Young Adult households.",
  ...
  "Adult Child households in which all adults are between 18 and 24 and one or more 
    of the adults is the parent of a child in the household.",
  ...
  "A Level of Detail selection that includes all heads of household regardless of 
    age and people 18 years old or older in all households.",
  ...
  "Project Type Group",
  "A single-select universal filter that allows users to filter system performance 
    data by six project type groups: All Project Types, All Residential Projects, 
    Residential: Homeless Projects, Residential: Permanent Housing Projects, All 
    Non-Residential Projects, and Non-Residential: Street Outreach Projects. Eva 
    system performance metrics and statuses reported by Project Type Group are 
    calculated based on project enrollments associated with the respective project 
    types within the selected Project Type Group. This means it is possible for 
    different Project Type Group selections to show different System Performance 
    results for the same client depending on the types of projects the client was 
    enrolled in during the report period.",
  ...
  "A Project Type Group selection that includes all clients in all HUD-defined 
    ...
    the default selection for the Project Type Group filter and provides the most 
    complete picture of system engagement for households who were enrolled in both 
    Residential and Non-Residential projects during the report period.",
  
  "Filters",
  "Project Type Group",
  "All Residential Projects",
  "A Project Type Group selection that only includes clients in projects that provide
    overnight accommodation. Project types that are considered as residential projects
    include: Emergency Shelter (ES) – Entry/Exit, ES -Night-by-Night, Safe Haven (SH), 
    Transitional Housing (TH), Permanent Housing (PH) - Housing Only, PH - Housing with 
    Services, PH - Permanent Supportive Housing, PH - Rapid Re-housing (RRH): Housing 
    with or without services, and PH- Rapid Re-housing (RRH): Services Only. Clients 
    enrolled in residential project types are considered to be experiencing homelessness 
    as of the enrollment’s Project Start Date. A client enrolled in a permanent housing 
    project who has moved into housing (i.e., has a Move-In Date) would no longer be 
    considered as experiencing homelessness. A Move-In Date that is after the Project 
    Exit Date is considered a data quality issue, and that Move-In Date is ignored.",
  
  "Filters",
  "Project Type Group",
  "Residential: Homeless Projects",
  "A Project Type Group selection that only includes 
    clients in a specific subset of residential projects: Emergency Shelter (ES) – 
    Entry/Exit, ES - Night-by-Night, Safe Haven (SH), and Transitional Housing (TH). 
    Clients enrolled in residential homeless project types are considered to be 
    experiencing homelessness as of the enrollment’s Project Start Date. For the purposes 
    of System Performance, for ES – Night-by-Night enrollments without Exit Dates, Eva 
    sets the Exit Date to be 15 days after the last recorded Bed Night or 15 days after 
    the Entry Date, whichever is later.",
  
  "Filters",
  "Project Type Group",
  "Residential: Permanent Housing Projects",	
  "A Project Type Group selection that only includes clients in a specific subset 
    of residential projects: Permanent Housing (PH) - Housing Only, PH – Housing with 
      Services, PH - Permanent Supportive Housing, PH - Rapid Re-housing (RRH): Housing 
      with or without services, and PH - Rapid Re-housing (RRH): Services Only. Clients 
      enrolled in residential project types are considered to be experiencing homelessness 
      as of the enrollment’s Project Start Date. A client enrolled in a permanent housing 
  ...
  "A Project Type Group selection that only includes clients in projects that do not 
    provide overnight accommodation. Project types that are considered as non-residential 
    include: Street Outreach, Day Shelter, Supportive Services Only, Coordinated Entry, and 
    Other. Since non-residential projects can serve both people who are experiencing 
    homelessness and those who are housed, non-residential enrollments must have a 
    documented homeless living situation in the Prior Living Situation (PLS) and/or a 
    Current Living Situation (CLS) record to be included in Eva’s system performance 
    calculations. Clients enrolled in Street Outreach are assumed to be experiencing 
    homelessness as of the enrollment’s Project Start Date no matter the recorded PLS. 
    For the purposes of System Performance, clients are considered active in long-term, 
    non-residential project enrollments if there is a homeless living situation documented 
    in a CLS record every 60 days. Coordinated Entry enrollments require a CLS record 
    every 90 days to be considered active. Additionally, non-residential enrollments are 
    considered active 15 days prior to the enrollment exit date if the exit destination is 
    to a homeless, institutional, temporary housing, or permanent housing destination. For 
    all non-residential project enrollments except for Street Outreach, Eva “resets” the 
    enrollment Entry Date to the date of the enrollment’s first literally homeless CLS 
    record if the enrollment does not have a literally homeless PLS. For any non-residential 
    enrollment without an Exit Date, Eva sets the Exit Date to be 60 days after the last 
    literally homeless CLS recorded for the enrollment or after the literally homeless PLS, 
  ...
  "A Project Type Group selection that only includes clients in Street Outreach projects.
    ...
    Street Outreach enrollments, there must be a homeless living situation documented in 
    a Current Living Situation (CLS) record every 60 days. Additionally, inactive Street 
    Outreach enrollments are considered active 15 days prior to the enrollment exit date 
    if the exit destination is to a homeless, institutional, temporary housing, or permanent 
    housing destination. Clients enrolled in Street Outreach for less than 60 days are 
    considered to be experiencing homelessness for the entire duration of that enrollment, 
    even if there was no CLS record entered within that time period. For any Street Outreach 
    enrollment without an Exit Date, Eva sets the Exit Date to be 60 days after the last 
    literally homeless CLS recorded for the enrollment or after the literally homeless PLS, 
    whichever is later.",
  ...
  "A multi-select demographic filter. Eva allows users to filter system performance 
    ...
    are: 0 to 12, 13 to 17, 18 to 21, 22 to 24, 25 to 34, 35 to 44, 45 to 54, 55 to 64, 
    65 to 74, 75 and older, and unknown.",
  ...
  "A single-select demographic filter. Eva allows users to filter system performance 
    ...
    to choose from. 
    The Detailed section lists all race/ethnicity categories on 
  ...
  "Filters",
  "Race/Ethnicity (Method 1), Race/Ethnicity (Method 2)",
  ...
  "Includes clients who identified as only Hispanic/Latina/o and no other race/ethnicity. 
    This Race/Ethnicity filter selection is listed under the Detailed section of the 
    filter dropdown list when Method 1 is selected and under the Summarized section of 
    the filter dropdown list when Method 2 is selected.",
  ...
  "Charts",
  "System Flow, Client System Status, System Demographics",
  "Total People",
  "Total People is the number of clients represented in the system performance overview 
    charts. For the System Flow Summary and Detail charts and the System Demographics 
    chart, Total People is calculated by adding the number of clients that were active 
    in the system at the beginning of the report period and the number of clients who 
    flowed into the system during the report period (Active at Start + Inflow). For the 
    Client System Status Chart, Total People is equal to the number of clients that were 
    active in the system at the beginning of the report period (Active at Period Start).",
  
  "Charts",
  "System Flow",
  "Total Change",
  "Total Change is calculated by subtracting the number of clients who flowed out 
    of the system from the number fof clients who flowed into the system (Inflow – Outflow). 
  ...
  "Charts",
  "System Flow, Client System Status",
  "Homeless (Active at Start/Period Start)",
  ...
  "Charts",
  "System Flow, Client System Status",
  "Housed (Active at Start/Period Start)",
  ...
  "This outflow system status indicates a client exited the system to a homeless, 
    ...
    on the last day of the report. In the Client System Status chart, this category 
    represents the client’s last exit in the report period.",
  ...
  "This outflow system status indicates a  client exited the system to a permanent 
    ...
    not active in the system on the last day of the report. In the Client System Status 
    chart, this category represents the client’s last exit in the report period.",
  
  "Charts",
  "System Flow, Client System Status",
  "Inactive (Outflow/Period End)",
  ...
  "Charts",
  "System Flow, Client System Status",
  "Homeless (Active at End) or Enrolled, Homeless",
  ...
  "Charts",
  "System Flow, Client System Status",
  "Housed (Active at End) or Enrolled, Housed",
  ...
  "Charts",
  "System Flow, Client System Status, Exits by Type, Exits by Year, Exits by Subpopulation, Permanent Housing Demographics",
  "System Exits",
  ...
  "Charts",
  "Exits by Type, Exits by Year, Exits by Subpopulation, Permanent Housing Demographics",
  "Total System Exits",
  "Total System Exits is the number of clients represented in the system exit charts. 
    For the Exits by Type chart, it lists the total count of system exits by the end of 
    the report period. For the Exits by Year chart, it lists (1) the total count of system 
    exits by the end of the report period as the “Total Current Year System Exits” and (2) 
    the total count of system exits by the end of the previous report period as the “Total 
    Previous Year System Exits.” For the Exits by Subpopulation chart, it lists (1) the total 
    count of system exits by then end of the report period for the selected subpopulation and (2) 
    the count for those not included in the selected subpopulation (“Everyone Else”). For the 
    Permanent Housing Demographics chart, it lists (1) the total count of all system exits by the 
    end of the report period and (2) the total count of system exits to the permanent housing 
    destination category by the end of the report period.",
  
  "Charts",
  "Exits by Type, Exits by Year, Exits by Subpopulation, Permanent Housing Demographics",
  "Percentage of System Exits",
  "The percentage of system exits is divided among the five destination categories, 
    which together total 100%. Each category’s percentage represents the share of all 
    exits in a given reporting year that ended in that specific destination.",
  
  "Charts",
  "Exits by Year", 
  "Percent Change",
  "In the Exits by Year chart, Percent Change represents how much a destination 
    category’s share of total system exits has increased or decreased from the previous 
    year to the current year. It is calculated as the difference between the percentage 
    of system exits to that destination in the current year and the percentage in the 
    previous year. This metric reflects the relative change over time, rather than the 
    absolute percentage‑point difference.",
  
  "Charts",
  "Exits by Subpopulation", 
  "Percent Difference",
  "In the Exits by Subpopulation comparisons, Percent Difference represents how much 
    higher or lower a subpopulation’s share of system exits is compared to the share 
    for all other individuals combined. It is calculated as the difference between the 
    percentage of system exits for the subpopulation and the percentage for everyone 
    else. This metric highlights relative differences between groups, rather than 
    absolute percentage‑point gaps.",
  
  "Charts",
  "Exits by Type, Exits by Year, Exits by Subpopulation, Permanent Housing Demographics", 
  "Permanent (Destination Category) or Permanent Housing (PH)",
  "This system exit destination category indicates a client exited the system to a 
    permanent destination as defined in the HMIS Data Standards. Permanent housing 
    situation destinations include (1) staying or living with family, permanent tenure, 
    (2) staying or living with friends, permanent tenure, (3) moved from one HOPWA 
    funded project to HOPWA PH, (4) rental by client, no ongoing housing subsidy, 
    (5) rental by client, with ongoing housing subsidy, (6) owned by client, with 
    ongoing housing subsidy, and (7) owned by client, no ongoing housing subsidy. 
    In the system exit charts, the count of system exits under the permanent destination 
    category represents the number of clients that exited to a permanent destination on 
    their last project enrollment during the report period. In the Summary and Detail 
    System Flow charts and the Client System Status chart, these exits to a homeless 
    destination are counted under Exited, Permanent.",
  
  "Charts",
  "Exits by Type, Exits by Year, Exits by Subpopulation", 
  "Homeless (Destination Category)",
  "This system exit destination category indicates a client exited the system to a 
    homeless destination as defined in the HMIS Data Standards. Homeless situation 
    destinations include (1) place not meant for habitation (e.g., a vehicle, an 
    abandoned building, bus/train/subway station/airport or anywhere outside), 
    (2) Emergency Shelter, including hotel or motel paid for with emergency shelter 
    voucher, Host Home shelter, and (3) Safe Haven. In the system exit charts, the 
    count of system exits under the homeless destination category represents the 
    number of clients that exited to a homeless destination on their last project 
    enrollment during the report period. In the Summary and Detail System Flow charts 
    and the Client System Status chart, these exits to a homeless destination are 
    counted under Exited, Non-Permanent.",
  
  "Charts",
  "Exits by Type, Exits by Year, Exits by Subpopulation", 
  "Institutional (Destination Category)",
  "This system exit destination category indicates a client exited the system to an 
    institutional destination as defined in the HMIS Data Standards. Institutional 
    situation destinations include (1) foster care home or foster care group home, 
    (2) hospital or other residential non-psychiatric medical facility, (3) jail, 
    prison, or juvenile detention facility, (4) long-term care facility or nursing home, 
    (5) psychiatric hospital or other psychiatric facility, and (6) substance abuse 
    treatment facility or detox center. In the system exit charts, the count of system 
    exits under the institutional destination category represents the number of clients 
    that exited to an institutional destination on their last project enrollment during 
    the report period. In the Summary and Detail System Flow charts and the Client 
    System Status chart, these exits to an institutional destination are counted under 
    Exited, Non-Permanent.",
  
  "Charts",
  "Exits by Type, Exits by Year, Exits by Subpopulation", 
  "Temporary (Destination Category)",
  "This system exit destination category indicates a client exited the system to a 
    temporary destination as defined in the HMIS Data Standards. Temporary housing 
    situation destinations include (1) transitional housing for homeless persons 
    (including homeless youth), (2) residential project or halfway house with no 
    homeless criteria, (3) hotel or motel paid for without emergency shelter voucher, 
    (4) Host Home (non-crisis), (5) staying or living with family, temporary tenure 
    (e.g., room, apartment, or house), (6) Staying or living with friends, temporary 
    tenure (e.g., room, apartment, or house), and (7) moved from one HOPWA funded 
    project to HOPWA TH. In the system exit charts, the count of system exits under 
    the temporary destination category represents the number of clients that exited 
    to a temporary destination on their last project enrollment during the report 
    period. In the Summary and Detail System Flow charts and the Client System Status 
    chart, these exits to a temporary destination are counted under Exited, Non-Permanent.",
  
  "Charts",
  "Exits by Type, Exits by Year, Exits by Subpopulation", 
  "Other/Unknown (Destination Category)",
  "This system exit destination category indicates a client exited the system to an 
    other/unknown destination as defined in the HMIS Data Standards. Other/Unknown 
    housing situation destinations include when there was no exit interview completed, 
    when the data was not collected, or if the client was deceased. In the system exit 
    charts, the count of system exits under the other/unknown destination category 
    represents the number of clients that exited to an other/unknown destination on 
    their last project enrollment during the report period. In the Summary and Detail 
    System Flow charts and the Client System Status chart, these exits to an other/unknown 
    destination are counted under Exited, Non-Permanent. Additionally, clients that fall 
    under the Eva calculated system status of “Inactive” are included in this destination category."
