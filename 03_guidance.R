...
guidance_missing_at_entry <- 
  str_squish("This data element is required to be collected at Project Start. Please
...
guidance_dkr_data <- 
  str_squish("It is widely understood that not every client will be able to or consent
