...
eva_colors <- function(color_name){
  
  color_options <- c('coral', 'light_green','dark_blue','med_gray','light_blue','light_coral','dark_purple','light_purple', 'very_light_purple')
  
  if(!(color_name %in% color_options)){
    stop("Please use a valid Eva color name")
  }
  switch(color_name,
         coral        = '#C2462E',
         light_coral  = '#D1AB98',
...
bar_colors <- c(
  "Inflow" = eva_colors('med_gray'),#"#BDB6D7", 
  "Outflow" = eva_colors('med_gray'),#'#6A559B',
  "Homeless" = eva_colors('coral'),
  "Housed" = eva_colors('dark_blue')
)

mbm_inflow_bar_colors <- c(
  "Active at Start: Homeless" = eva_colors('coral'),
  "Inflow" = eva_colors('med_gray')#"#BDB6D7"
)
...
mbm_outflow_bar_colors <- c(
  "Outflow" = eva_colors('med_gray'),#'#6A559B',
  # "Inactive" = "#E78AC3"
  "Active at End: Housed" = eva_colors('dark_blue')
)
...
sankey_bar_colors <- c(
  "Housed" = eva_colors('dark_blue'), 
  "Homeless" = eva_colors('coral'),
  "Exited, Non-Permanent" = eva_colors('light_coral'),
  "Enrolled, Homeless" = eva_colors('coral'),
  "Inactive" = eva_colors('med_gray'),
  "Exited, Permanent" = eva_colors('light_blue'),
  "Enrolled, Housed" = eva_colors('dark_blue')
)
